...
function PLUGINS.lsp_keymaps()
  vim.api.nvim_create_autocmd('LspAttach', {
    ...
    callback = function(event)
      ...
      key_map('<leader>gi', require('telescope.builtin').lsp_implementations, '[I]mplementation')
      key_map('<leader>gt', require('telescope.builtin').lsp_type_definitions, '[T]ype Definition')
      key_map('<leader>gs', require('telescope.builtin').lsp_document_symbols, 'Find [S]ymbols')
      key_map('<leader>gw', require('telescope.builtin').lsp_dynamic_workspace_symbols, '[W]orkspace Symbols')
